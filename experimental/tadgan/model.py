...
class Decoder(nn.Module):
    def __init__(self, decoder_path, signal_shape=100):
        ...
        self.signal_shape = signal_shape
        self.lstm = nn.LSTM(input_size=100, hidden_size=64, num_layers=2, bidirectional=True)
...
class CriticZ(nn.Module):
    def __init__(self, critic_z_path):
        ...
        self.dense1 = nn.Linear(in_features=100, out_features=1)
